...
proc create_root_design { parentCell } {
  ...
  set ZYNQMP_ACP_ADAPTER_0 [ create_bd_cell -type ip -vlnv ikwzm:PIPEORK:ZYNQMP_ACP_ADAPTER:0.4 ZYNQMP_ACP_ADAPTER_0 ]
  set_property -dict [ list \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ArgSort_AXI_1_MRG_AXI] [get_bd_intf_pins ArgSort_AXI_1/MRG_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets ArgSort_AXI_1_MRG_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ArgSort_AXI_1_STM_AXI] [get_bd_intf_pins ZYNQMP_ACP_ADAPTER_0/AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets ArgSort_AXI_1_STM_AXI]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins axi_interconnect_csr/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins ArgSort_AXI_1/ARESETn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
